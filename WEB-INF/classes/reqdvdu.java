...
public class reqdvdu extends HttpServlet {
    ...
    "<body>"+
		...
		+"<br />"
		+"Request: <input type=\"text\" name=\"request\" placeholder='Request your text here'> <br />"
		+"<br />"
	...
	{
		 String stm="insert into  requests (requests,userid) values('"+requests+"','"+d+"')";
	//ut.println(stm);
	  try{
	ob.executeQuery(stm);
		 //out.println(stm);
