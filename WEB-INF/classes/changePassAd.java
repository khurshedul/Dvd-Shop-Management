...
public class changePassAd extends HttpServlet {
    ...
    "<body>"+
		...
		+"<br />"
		+"New Password: <input type=\"password\" name=\"newp\" placeholder='new'>"
		+"<br />"
	...
	{
		 String stm="update  users set password='"+newp+"' where user_name='"+d+"'";
	 //out.println(stm);
	  try{
	ob.executeQuery(stm);
		 //out.println(stm);
