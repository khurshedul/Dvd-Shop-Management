...
public class adddvd extends HttpServlet {
    ...
    "<body>"+
		...
		+"<br />"
		+"Title Dvd: <input type=\"text\" name=\"title\" placeholder='Title'> <br />"
		+"Actor/Actress: <input type=\"text\" name=\"actor\" placeholder='Actor/actress'> <br />"
		+"Category Id: <input type=\"text\" name=\"catid\" placeholder='category'> <br />"
		+"<br />"
	...
	{
		 String stm="insert into  dvds (title,actor,catagory_id) values('"+title+"','"+actor+"',"+catid+")";
	// out.println(stm);
	  try{
	ob.executeQuery(stm);
		 //out.println(stm);
