...
public class usearch extends HttpServlet {
    ...
    "<body>"+
        ...
        +"Search Dvds: <input type=\"text\" name=\"search\" id=\"myid\"   placeholder='User ID '>"
	...
	{
		String sql3="SELECT * from users where  type='user' and user_name like '%"+search+"%'";
	    ...
	    while(r.next()){
			 ...
			 out.println("<td>"+r.getString("user_name")+"</td>");
